...
def get_TCT(root, image_set, transforms, mode='instances'):

    PATHS = {
        "trainval": ("train", os.path.join("annotations", 'train.json')),
        "test": ("val", os.path.join("annotations", 'val.json')), 
    }
